...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  const locked = (deps = []) => !deps.every((d) => completed[d]);
            ...
            {expanded.pertemuan1 && (
              <div className="ml-4 mt-2 space-y-2">
                ...
                <Link
                  ...
                  onClick={() => markDone("p1_submission", ["p1_m2"])}
                  className={`${itemBase} ${
                    locked(["p1_m2"])
                      ? "opacity-50 pointer-events-none text-gray-400"
            ...
            {!locked(["p1_submission"]) && expanded.pertemuan2 && (
              <div className="ml-4 mt-2 space-y-2">
                <Link
                  ...
                  onClick={() => markDone("p2_m1", ["p1_submission"])}
                ...
                <Link
                  to="/submission/pertemuan-2"
                  onClick={() => markDone("p2_submission", ["p2_m1"])}
                  className={`${itemBase} bg-orange-50 text-orange-600 hover:bg-orange-100`}
                >
                  <Check size={18} />
                  <span>Submission Pertemuan 2</span>
                </Link>
              </div>
            )}
          </div>
